...
- Customer can view details of suitable venues.
Trigger:
Customer wants to find a suitable venue for an event.
Main Flow:
...
2. Use Case: Venue Owner Contact details.
Primary Actor: Customer / User
Stakeholders:
- Customer
- Venue Owner
...
Trigger:
Customer wants to contact the Venue Owner to proceed with booking the venue.
Main Flow:
...
7. Booking is arranged directly between the Customer and Venue Owner.
Alternate Flows:
...
Trigger:
Venue Owner wants to add a new venue or update an existing venue.
Main Flow:
